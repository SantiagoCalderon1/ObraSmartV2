import { fetchCompany } from "../Services/services.js"
import { URL_IMAGE } from "../Util/constantes.js"
import { TableModal } from "./table-modal.js"


export function GeneratePDF() {
    let company = {}, invoice = {}, estimate = {}, client = {}, title = ""
    return {
        ...
        view: function () {
            ...
            const footerDocument = () => [
                ...
                m("div.row.mt-2.py-2", [
                    m("div.card", [
                        m("div.text-end.p-3", [
                            m("p.mb-0.fw-bold", `SubTotal: €${(estimate?.total_cost / (1 + (estimate?.iva || 0) / 100)).toFixed(2)}`),
                            m("p.mb-0.fw-bold", `IVA: ${estimate?.iva}%`),
