...
export function Modal() {
    return {
        view: function ({ attrs }) {
            const { idModal, title, addBtnClose, maxHeight = true } = attrs
            ...
            return m("div.modal.fade", {
                ...
                m("div.modal-dialog.modal-xl.modal-dialog-centered", [
                    m("div.modal-content", [
                        ...
                        m("div.modal-body.d-flex.justify-content-center", { style: { maxHeight: maxHeight ? "50vh" : "" } }, slots.body ? slots.body : "Cargando detalles..."),
